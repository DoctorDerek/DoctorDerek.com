...
export default function TopSection() {
  return (
    <div className="relative h-dvh">
      ...
      <div className="flex h-[93dvh] translate-y-12 scale-95 flex-col items-center justify-center opacity-0 transition-all duration-700 ease-spring-bouncy [.active_&]:translate-y-0 [.active_&]:scale-100 [.active_&]:opacity-100">
