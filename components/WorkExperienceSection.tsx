...
export default function WorkExperienceSection() {
  ...
  return (
    <div className="relative flex h-screen flex-col items-center justify-center pt-16">
      ...
      <div className="ml-auto mt-6 h-[42vh] w-[95%] lg:hidden">
      ...
      <div className="mx-auto hidden lg:block lg:h-[65%] lg:w-11/12 mt-12">
        <div className="flex h-[30vh] w-full flex-col md:h-[30vh] lg:relative lg:h-full">
                ...
                >
                  <div className="relative flex flex-col text-white">
                    ...
                    <p
                      ...
                      } restorabold py-2 text-xl font-medium max-w-sm`}
                    >
                      {item.company}
                    </p>
                  </div>
          ...
          <div className="mb-2 ml-6 mt-auto flex w-[65%] justify-between gap-y-4 md:ml-12 md:w-[50%] lg:mb-28 lg:ml-32 lg:grid lg:w-1/5 lg:grid-cols-2 lg:grid-rows-3 lg:gap-x-6">
            <a
              className="text-white md:flex lg:text-xl font-bold"
            ...
            <a
              ...
              className="text-lg text-white md:flex lg:text-xl font-bold"
              target="_blank"
            >
