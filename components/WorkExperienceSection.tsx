...
export default function WorkExperienceSection() {
  return (
    <div className="relative flex min-h-full w-full flex-col items-center justify-start py-20 pb-24 lg:h-full lg:justify-center lg:py-4">
      ...
      <div className="ease-spring-soft mx-auto mt-6 w-[95%] translate-y-12 opacity-0 transition-all delay-200 duration-700 lg:mt-8 lg:w-[94%] lg:rounded-3xl lg:border lg:border-site-border lg:bg-site-surface lg:px-6 lg:py-7 lg:backdrop-blur-xl xl:px-8 xl:py-9 [.active_&]:translate-y-0 [.active_&]:opacity-100">
        <ol
          aria-label="Career timeline"
          className="flex flex-col border-[#F38B57] lg:grid lg:grid-cols-4 lg:border-t-4"
        >
          {ARCHITECT_EVOLUTION.map((item, index) => (
            <li
              key={item.duration}
              className={classNames(
                "ease-spring-soft relative translate-y-12 border-l-4 border-[#F38B57] pb-8 pl-6 opacity-0 transition-all duration-700 lg:min-w-0 lg:pt-8 lg:pr-5 lg:pb-0 lg:pl-5 [.active_&]:translate-y-0 [.active_&]:opacity-100",
