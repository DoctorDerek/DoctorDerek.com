...
export default function DrMapacheSection() {
  return (
    <div className="flex h-full w-full items-center justify-center p-8 py-20">
      <div className="ease-spring-bouncy flex h-[80vh] w-full max-w-6xl translate-y-12 flex-col items-center justify-center rounded-3xl border-4 border-[#F38B57] bg-black/80 opacity-0 shadow-[0_0_40px_rgba(243,139,87,0.4)] transition-all duration-700 [.active_&]:translate-y-0 [.active_&]:opacity-100">
