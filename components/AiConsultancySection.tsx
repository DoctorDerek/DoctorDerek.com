...
export default function AiConsultancySection() {
  return (
    <div className="flex h-full w-full items-center justify-center p-4 py-20 md:p-8">
      <div className="flex max-h-full max-w-4xl translate-y-12 scale-95 flex-col rounded-2xl border border-white/20 bg-white/10 p-6 text-white opacity-0 backdrop-blur-md transition-all duration-700 ease-spring-bouncy md:p-12 normal-scroll-content overflow-y-auto overscroll-contain [.active_&]:translate-y-0 [.active_&]:scale-100 [.active_&]:opacity-100">
