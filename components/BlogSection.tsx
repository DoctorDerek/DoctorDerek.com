        ...
        <div className="flex h-full w-full items-center justify-center p-4">
          <div className="mx-auto mt-16 w-full max-w-4xl rounded-2xl border border-white/10 bg-black/40 p-6 text-white shadow-2xl backdrop-blur-md md:mt-24 md:p-12 opacity-0 transition-all duration-700 ease-spring-soft [.active_&]:opacity-100 translate-y-12 [.active_&]:translate-y-0">
            ...
            <h3 className="mb-8 text-center text-lg leading-snug font-bold text-white/90 md:text-2xl">
              Tired of generic tech industry noise? Join <span className="text-[#F38B57] inline-block min-w-[4ch] tabular-nums"><CountUp to={BLOG_METRICS.emailSubscribers} /></span> insider subscribers and <span className="text-[#008EC1] inline-block min-w-[7ch] tabular-nums"><CountUp to={BLOG_METRICS.mediumFollowers} duration={2.5} /></span> followers reading my battle-tested systems analyses and survival manuals for your SWE career.
            </h3>
